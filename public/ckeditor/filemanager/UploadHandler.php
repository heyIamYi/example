...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'inline_file_types' => '/\.(gif|jpe?g|png|svg|webp|avif)$/i',
            ...
            'accept_file_types' => '/\.(gif|jpe?g|png|svg|webp|avif)$/i',
    ...
    protected function fix_file_extension($file_path, $name, $size, $type, $error,
        ...
        if (strpos($name, '.') === false &&
                preg_match('/^image\/(gif|jpe?g|png|svg|webp|avif)/', $type, $matches)) {
            $name .= '.'.$matches[1];
        }
    ...
    protected function is_valid_image_file($file_path) {
        if (!preg_match('/\.(gif|jpe?g|png|svg|webp|avif)$/i', $file_path)) {
            return false;
        }
