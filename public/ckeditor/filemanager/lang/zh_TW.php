...
return array(
    ...
    'Images' => '圖片',
    'Archives' => '存檔',
    'Error_Upload' => '上傳的檔案超過了允許的最大尺寸',
    'Error_extension' => '此類檔案不被支援',
    'Upload_file' => '上傳',
    'Filters' => '過濾',
    'Videos' => '影片',
    'Music' => '音樂',
    ...
    'Confirm_Folder_del' => '確定刪除此資料夾和里面的所有檔案?',
    'Return_Files_List' => '返回檔案列表',
    'Preview' => '預覽',
    'Download' => '下載',
    ...
    'Empty_name' => '請輸入檔案名',
    'Text_filter' => '文字過濾',
    'Swipe_help' => '在檔案或資料夾的名稱上劃過已顯示更多選項',
    'Upload_base' => '普通上傳',
    ...
    'CB' => '複製框', // clipboard
    'Paste_Here' => '複製到這個目錄',
    'Paste_Confirm' => '確定複製到這個目錄? 這有可能會覆蓋已經存在的檔案或資料夾',
    'Paste_Failed' => '檔案複製失敗',
    'Clear_Clipboard' => '清除複製框',
    'Clear_Clipboard_Confirm' => '確定清除複製框?',
    'Files_ON_Clipboard' => '複製框上還有檔案存在',
    'Copy_Cut_Size_Limit' => '無法 %s 選擇的檔案，選擇的檔案太大，超過了允許的大小: %d MB', // %s = cut or copy
    'Copy_Cut_Count_Limit' => '無法 %s 選擇的檔案，您選擇的檔案和資料夾數目超過限制: %d 個檔案', // %s = cut or copy
    ...
    'Zip_No_Extract' => '檔案解壓縮失敗。檔案可能已經損壞',
    'Zip_Invalid' => '不支持此檔案後綴，支持的後綴名: zip, gz, tar.',
